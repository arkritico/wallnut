...
export async function POST(request: Request) {
  try {
    ...
    // Truncate all inputs to prevent token abuse
    ...
    // Extract regulation references from the answer
    ...
    return NextResponse.json({
      ...
      regulationReferences: [],
      suggestions: [],
      error: "Erro interno ao processar o pedido de IA.",
    } satisfies AIAnalysisResponse, { status: 500 });
  }
}
