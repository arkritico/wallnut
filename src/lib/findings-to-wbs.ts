...
const AREA_REMEDIATION_CONFIG: Record<RegulationArea, {
  ...
  avac: { chapterCode: "04", chapterName: "AVAC", specialty: "AVAC", baseDays: 8 },
  ...
  ited_itur: { chapterCode: "08", chapterName: "Telecomunicações", specialty: "ITED", baseDays: 5 },
  ...
  local: { chapterCode: "16", chapterName: "Regulamentação Municipal", specialty: "Urbanismo", baseDays: 5 },
